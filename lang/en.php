...
return [
    ...
    'footer_powered' => 'Powered by <a href="https://www.bulletinbored.net" target="_blank" rel="noopener">bulletinbored</a>',
    ...
    'test_email_hint' => 'Enter the address where to send the test email to verify your configuration.',
    'send_test_email' => 'Send Test Email',
    'invalid_email_address' => 'Invalid email address.',
    'email_test_success' => 'Test email sent successfully to {email}. Check your inbox (and spam).',
    'email_test_error' => 'Failed to send test email: {error}',
    ...
    'plugin_zip_requirement' => 'The ZIP must contain a folder with <code>manifest.json</code> and a bootstrap file (e.g. <code>plugin.php</code>).',
